        ...
        return [
            ...
            html.P(
                [
                    ...
                    ": percentage of total bets and raises after flop, divided by the number of calls",
                    html.Br(),
                    html.Span(
                        "WTS (Went To Showdown)",
                        className="p-short p-bold",
                    ),
                    ": percentage of times user went to showdown after seeing flop",
                    html.Br(),
                    html.Span(
                        "WSD (Won Showdown)",
                        className="p-short p-bold",
                    ),
                    ": percentage of times user won showdown, divided by the number of times went to showdown",
                ],
                className="div-with-image div-with-small-image-left div-with-small-image-right small-image",
            ),
            html.P(
